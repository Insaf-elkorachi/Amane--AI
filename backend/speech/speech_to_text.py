...
class SpeechToTextAdapter:
    ...
    def fix_domain_terms(text: str) -> str:
        ...
        replacements = [
            (r"بريتمو\s+صرح", "بغيت نصرح"),
            (r"بريتو\s+صرح", "بغيت نصرح"),
            (r"بغيتو\s+صرح", "بغيت نصرح"),
            (r"بريتمو\s+نصرح", "بغيت نصرح"),
            (r"بغيت\s+نصرح\s+ب\s*وضعية\s+خطيرة", "بغيت نصرح بوضعية خطيرة"),
            (r"بغيت\s+نصرح\s+بوضعية\s+خطيرة", "بغيت نصرح بوضعية خطيرة"),
            (r"اريد\s+ان\s+اصرح\s+بوضعية\s+خطيرة", "بغيت نصرح بوضعية خطيرة"),
            (r"أريد\s+أن\s+أصرح\s+بوضعية\s+خطيرة", "بغيت نصرح بوضعية خطيرة"),
            (r"تسجيل\s+تصريح\s+ديال\s+السلامة", "بغيت نسجل تصريح ديال السلامة"),
            (r"وضعية\s+خطيرة", "وضعية خطيرة"),
            ...
            (r"\bformeurs\s+de\s+spires\b", "formeurs de spires"),
            ...
            (r"\bformeurs\s+de\s+couronnes\b", "formeurs de couronnes"),
